...
import {
  Award, Loader2, ImageIcon, X, ArrowLeft,
  Star, Clock, Shield, CheckCircle2, AlertTriangle, ChevronRight, Users, Target
} from 'lucide-react'
        ...
        {step === 'form' ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="lg:col-span-2 bg-[#161616] border border-[#C9A84C]/25 p-8 relative">
              ...
              {/* Submit */}
              {!isAuthenticated ? (
                <div className="text-center p-4 border border-[#C9A84C]/20">
                  <p className="text-sm text-[#C8BC98] mb-3">Sign in to submit for expert review</p>
                  <Link to="/login" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-[#C9A84C] to-[#8A6E2F] text-[#080808] font-cinzel text-[10px] tracking-[3px] uppercase font-bold">
              ...
              <div className="p-4 border border-red-500/20 bg-red-500/5">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-[9px] text-red-300/70 leading-relaxed">
                    The Vault connects you with independent expert appraisers. Review fees go directly to the experts. We are not liable for expert opinions or valuations. All assessments are professional opinions, not guarantees.
