...
export function getSecurityHeaders(): Record<string, string> {
  return {
    ...
    "Content-Security-Policy":
      ...
      "connect-src 'self' https://api.stripe.com https://api.mainnet-beta.solana.com https://api.opensea.io https://api.rarible.org https://api.magiceden.dev https://accounts.google.com https://oauth2.googleapis.com https://api.github.com https://api.x.com https://openrouter.ai; " +
      "frame-src 'self' https://js.stripe.com https://hooks.stripe.com; " +
      "media-src 'none'; " +
      "worker-src 'self' blob:; " +
      "object-src 'none'; " +
      "base-uri 'self'; " +
      "form-action 'self' https://accounts.google.com https://github.com https://x.com; " +
